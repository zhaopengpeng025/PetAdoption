...
class MainViewModel : ViewModel() {
    ...
    var adoptionList = listOf(
        AdoptionInfo(
            Puppy(
                "Sky", Gender.Boy, "3~4 month", 1200, story1,
        ...
        AdoptionInfo(
            Puppy(
                "Desk", Gender.Girl, "5~6 month", 1200, story1,
        ...
        AdoptionInfo(
            Puppy(
                "Mobil", Gender.Boy, "13~14 month", 1200, story1,
        ...
        AdoptionInfo(
            Puppy(
                "Jet", Gender.Girl, "8~9 month", 1200, story1,
        ...
        AdoptionInfo(
            Puppy(
                "Himalaya", Gender.Girl, "10 month", 1200, story1,
        ...
        AdoptionInfo(
            Puppy(
                "Sea", Gender.Boy, "19 month", 1200, story1,
        ...
        AdoptionInfo(
            Puppy(
                "River", Gender.Boy, "3~4 month", 1200, story4,
